...
export function MainHeader() {
  ...
  return (
    <header className="z-50 fixed w-full  border-white border-b-2 text-white font-poppins">
      <MaxWidth>
            ...
            <div className="flex items-center gap-3 lg:gap-4  justify-end">
              <form className="relative hidden sm:block">
                <input
                  ...
                  className="bg-white text-black rounded-sm lg:w-72 w-56 py-2 px-3 lg:px-4 placeholder:text-xs lg:placeholder:text-sm"
                />
